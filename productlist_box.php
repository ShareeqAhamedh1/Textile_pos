							...
							<div class="table-top">
								<div class="search-set">
									...
									<div id="DataTables_Table_0_filter" class="dataTables_filter">
										<label>
											<input id="myInput" onkeyup="myFunction()" type="search" class="form-control form-control-sm" placeholder="Search Box Number" aria-controls="DataTables_Table_0">
										</label>
									</div>
								</div>
								<div class="search-input" style="margin-right:10px">
								...
								<div id="DataTables_Table_0_filter" class="dataTables_filter">
									<label>
										<input id="myInput4" onkeyup="myFunction4()" type="search" class="form-control form-control-sm" placeholder=" Reference Number" aria-controls="DataTables_Table_0">
									</label>
								</div>
							</div>
								...
								<div id="DataTables_Table_0_filter" class="dataTables_filter">
									<label>
										<input id="myInput2" onkeyup="myFunction2()" type="search" class="form-control form-control-sm"
										placeholder="Search Barcode" aria-controls="DataTables_Table_0">
									</label>
								</div>
								</div>
							</div>
		...
		function myFunction() {
		  ...
		  for (i = 1; i < tr.length; i++) {
			...
			// input = document.getElementById("myInput");
			// $('#product_table').load('product_table_box.php',{
			// 	word : input
			// });
			}
	...
	function ExportToExcel() {
		...
		var key_two = document.getElementById('myInput4').value;

		if(key != "" && key != ""){
			window.open("excel_box.php?word="+key+"&word_ref="+key_two,"_blank");
		}
		else if(key != ""){
		  window.open("excel_box.php?word="+key,"_blank");
	  }
		else if(key_two != ""){
			window.open("excel_box.php?word_ref="+key_two,"_blank");
		}
 	  else {
		 window.open("excel_box.php","_blank");
	  }
	}
