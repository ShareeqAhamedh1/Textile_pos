					...
					<div class="card">
						<div class="card-body">
							<div class="table-top">
								...
								<div id="DataTables_Table_0_filter" class="dataTables_filter">
									<label>
										<input id="myInput2" type="date" class="form-control form-control-sm" placeholder="Search Barcode" aria-controls="DataTables_Table_0">
									</label>
								</div>
								</div>
							</div>
				...
				<div class="modal-dialog modal-xl modal-dialog-centered" role="document">
					<div style=""  class="modal-content">
						...
						<div class="modal-body">
							<div class="row">
								<form id="my-form" class="" action="./backend/manage_stock.php" method="post">
									<div id="modal_form" class="">
		...
		$("#my-form").submit(function(event) {
		    ...
		    // Call your function to send the form data using AJAX
				var formData = $("#my-form").serialize();

    // Send the data using AJAX
    $.ajax({
        type: "POST",
        url: "./backend/manage_stock.php",
        data: formData,
				success: function(dataResult){
					var dataResult = JSON.parse(dataResult);
					if(dataResult.statusCode==200){

						$('#modal_form').load('manage_modal_table.php');
						$('#product_table').load('product_manage_table.php');
						Swal.fire({
							type: "success",
							title: "Updated!",
		...
		function myFunction() {
		  ...
		  for (i = 1; i < tr.length; i++) {
			...
			function loadValue(id){
				$('#modal_form').load('manage_modal_table.php',{ id : id});
			}
