					...
					<!-- /add -->
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="col-12">
									<input type="search" name="" value="" placeholder="Search By Reference Number" class="form-control" id="search_key" onkeyup="search_ref(this.value)" autofocus>
									<br>
									<div id="load">
