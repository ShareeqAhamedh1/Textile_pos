			...
			<div class="page-wrapper ms-0">
					...
					<div class="row">
						<div class="col-lg-8 col-sm-12 tabs_wrapper" >
							...
							<div id="" class="row form-group">
										...
										<a onclick="searchProd()" class="btn btn-filters ms-auto">
                ...
                <?php }} ?>
							...
							<div class="col-lg-4 col-sm-12 ">
								<form class="" action="./backend/order.php" method="post">
										...
										<div class="row">
											...
											<div class="col-lg-12">
												<div class="text">
													...
													<input disabled class="form-control" type="text" name="customer" id="customer" value="" placeholder="Customer Name"><br>
													<input class="form-control" type="hidden" name="customer_id" id="customer_id" value="" placeholder="Customer Name">
												</div>
											</div>
											<div class="col-lg-12">
												<div class="select-split ">
													<div class="select-group w-100">
														<select class="select" id="store_id" name='store_id'>
														  <option value="2">Cardamum</option>
														</select>
													</div>
												</div>
											</div>
											...
											<div class="col-lg-4">
												<div class="text">
													<!-- <a class="btn btn-scanner-set"><img src="assets/img/icons/scanner1.svg" alt="img" class="me-2">Scan bardcode</a> -->
													<input class="form-control" onkeyup="totalValue()" type="text" id="delivery_charge" name="delivery_charge" value="0" placeholder="Delivery Charge"><br>
												</div>
											</div>
											<!-- <div class="col-lg-6">
												<div class="select-split ">
										...
										<div class="setvaluecash">
											<ul>
												<li style="margin-right: 0px">
													<button style="width:90px; height:62px" type="submit" class="btn btn-block btn-outline-success" type="submit" value="0" name="button">
														<!-- <img src="assets/img/icons/cash.svg" alt="img" class="me-2"> -->
														Cash
													</button>
												</li>
												<li style="margin-right: 0px">
													<button style="width:90px; height:62px" type="submit" class="btn btn-block btn-outline-success" type="submit" value="1" name="button">
														<!-- <img src="assets/img/icons/cash.svg" alt="img" class="me-2"> -->
														Online Payment
													</button>
												</li>
												<li style="margin-right: 0px">
													<button style="width:90px; height:62px" type="submit" class="btn btn-block btn-outline-success" type="submit" value="2" name="button">
														<!-- <img src="assets/img/icons/cash.svg" alt="img" class="me-2"> -->
														Bank Transfer
													</button>
												</li>
											...
											<ul>
												<li style="margin-right: 0px">
													<button style="width:90px; height:62px" type="submit" class="btn btn-block btn-outline-success" type="submit" value="3" name="button">
														<!-- <img src="assets/img/icons/cash.svg" alt="img" class="me-2"> -->
														Credit
													</button>
												</li>
